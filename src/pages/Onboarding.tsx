        ...
        {step === 1 && (
          <>
            ...
            <button 
              ...
              className="w-full max-w-sm bg-white border border-gray-300 text-gray-700 py-3 rounded-xl font-medium flex items-center justify-center mb-6 hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
              {isAuthenticating ? (
