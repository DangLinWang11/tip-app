  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4">
      ...
      <div className="space-y-2">
        <input className="w-full rounded-xl border border-slate-300 p-2 text-base" placeholder="Title" value={title} onChange={e => setTitle(e.target.value)} />
        <textarea className="w-full rounded-xl border border-slate-300 p-2 text-base" placeholder="Description" value={description} onChange={e => setDescription(e.target.value)} />
